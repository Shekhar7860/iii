...
export default class Login extends Component {
  ...
  goBack = () =>{
   ...
   submit = () => {
       ...
       if (this.state.location && this.state.mobile )
       {
    ...
    return (
      ...
      <View style={{flex:1}}>
         ...
         <TouchableOpacity onPress={() => this.goBack()}>
                    ...
                    <Text style={styles.toolbarTitle}>Post P.G</Text>
               ...
               />
                ...
                <Picker style={styles.pickerStyle}  
                        ...
                        onValueChange={(itemValue, itemPosition) =>  
                            this.setState({rent: itemValue, choosenIndex: itemPosition})}  
                    >  
                    <Picker.Item label="Rent"   value="j5000-10000" /> 
                ...
                <Picker style={styles.pickerStyle}  
                        selectedValue={this.state.salary}  
                        onValueChange={(itemValue, itemPosition) =>  
                            this.setState({rooms: itemValue, choosenIndex: itemPosition})}  
                    >  
                    <Picker.Item label="Rooms"   value="j5000-10000" /> 
                ...
                <Picker style={styles.pickerStyle}  
                        ...
                        onValueChange={(itemValue, itemPosition) =>  
                            this.setState({food: itemValue, choosenIndex: itemPosition})}  
                    >  
                ...
                <Picker style={styles.pickerStyle}  
                        selectedValue={this.state.shift}  
                        onValueChange={(itemValue, itemPosition) =>  
                            this.setState({furnished: itemValue, choosenIndex: itemPosition})}  
                    >  
                    <Picker.Item label="Furnished" value="Food" />
                    <Picker.Item label="Yes" value="Yes" />  
                    <Picker.Item label="No" value="No" />  
                </Picker>  
                </View>
                ...
                <TouchableOpacity style={styles.fullWidthButton2} onPress={() => this.submit()}>
